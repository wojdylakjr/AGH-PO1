...
// Celem jest przygotowanie wielu różnych konstruktorów, pozwalających na tworzenie takich list w różny sposób. Proszę zadbać o odpowiednią implementację konstruktorów, wykorzystanie list inicjalizujących, zaimplementować konstruktor kopiujący przenoszący etc.

// Aby użyć std::initializer_list<int> należy załadować nagłówek:
// #include <initializer_list>
 
// Implementując listę, warto przechowywać informację o początku (head) jak i końcu listy (tail). Przyda się też przechowywać jej rozmiar.
#include "MyList.h"
#include <iostream>
