...
// Należy zaimplementować klasy Wierzcholek, Figura, Prostokat, KontenerFigur. Zakładamy że wierzchołki mogą leżeć tylko w punktach reprezentowanych liczbami całkowitymi (wierzcholek to punkt na plaszczyźnie 2D).
